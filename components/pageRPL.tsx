...
const SOFTWARE_DATA: SoftwareProject[] = [
  {
    ...
    tagline: "SaaS for Environmental Monitoring",
    desc: "Platform manajemen data emisi karbon untuk perusahaan manufaktur.",
    fullDesc:
      "Sistem dashboard berbasis cloud yang mengintegrasikan data dari berbagai sensor di lapangan ke dalam laporan analitik yang siap pakai untuk audit lingkungan.",
    stack: ["Next.js", "TypeScript", "Tailwind", "PostgreSQL"],
    imgCard: "/img/logo.png",
    imgDetail: "/img/soft1-large.jpg",
  },
  {
    id: 2,
    title: "MedLink Pro",
    tagline: "Telemedicine Management System",
    desc: "Aplikasi rekam medis digital yang aman dan terintegrasi.",
    fullDesc:
      "Solusi end-to-end untuk klinik yang mencakup penjadwalan dokter, manajemen pasien, hingga integrasi apotek dalam satu sistem enkripsi tingkat tinggi.",
    stack: ["React Native", "Node.js", "MongoDB", "AWS"],
    imgCard: "/img/soft2-card.jpg",
    imgDetail: "/img/soft2-large.jpg",
  },
  {
    id: 3,
    title: "Smart Inventory",
    tagline: "AI-Driven Logistics Software",
    desc: "Prediksi stok barang otomatis menggunakan Machine Learning.",
    fullDesc:
      "Membantu gudang logistik mengurangi pemborosan dengan memprediksi kapan barang harus di-restock berdasarkan tren pasar historis.",
    stack: ["Python", "Flask", "TensorFlow", "Redis"],
    imgCard: "/img/soft3-card.jpg",
    imgDetail: "/img/soft3-large.jpg",
  },
];
...
export default function SoftwarePage() {
  ...
  const handleNav = (index: number) => {
    ...
    // Geser berdasarkan lebar card (580px) + gap (40px)
    ...
    cards.forEach((card, i) => {
      gsap.to(card, {
        ...
        scale: i === index ? 1 : 0.95, // Scale diperhalus
        duration: 0.8,
        overwrite: true,
      });
    });
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-[#050B10] text-white font-sans max-w-full">
      {/* BG GRADIENT */}
      ...
      {/* NAV CONTROLS */}
      <div className="absolute bottom-12 left-10 md:left-24 z-[60] flex items-center gap-6">
      ...
      {/* RIGHT SIDE: MOCKUP TRACK (PERBESAR & GESER KIRI) */}
      ...
      <div
        ...
        className="fixed inset-0 z-[100] bg-[#050B10]/95 backdrop-blur-xl flex items-center justify-center p-4 md:p-12"
      >
        <div
          ref={modalContentRef}
        ...
        >
          <button
            ...
            className="absolute top-6 right-6 z-[120] bg-white text-black px-4 py-2 rounded-full text-[10px] font-black uppercase md:hidden"
          >
            X
          </button>

          {/* Sisi Kiri: Preview Image */}
